...
public final class EnergyNet {
	...
	/**
	 * Add a tile entity to the energy network. The tile entity has to be valid
	 * and initialized.
	 * 
	...
	/**
	 * Removes a tile entity from the energy network. The tile entity has to be
	 * still valid.
	 * 
	 * @param removedTileEntity
	 *            tile entity to remove
	 * 
	 ...
	 * 
	 * @param energySource
	 *            energy source to emit energy from
	 * @param amount
	 *            amount of energy to emit in EU
	...
	/**
	 * Get the amount of energy currently being conducted by a conductor. Call
	 * this twice with a delay to get the average conducted power by doing
	 * (call2 - call1) / 2.
	 * 
	 * @param tileEntity
	 *            conductor
