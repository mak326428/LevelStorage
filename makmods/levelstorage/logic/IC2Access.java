...
/**
 * Access for the IC2 features that are not in API. Most of these are hacky and
 * really inefficient ways of doing it (reflection is a perfomance penalty), but
...
public class IC2Access {
	...
	/**
	 * Whether or not is IC2-key down? (This method uses reflection, don't use
	 * it too much)
	 * 
	 * @param keyName
	 *            Name of the key (use JD-Gui to get names of them) Examples:
	 *            "Jump" "Boost" "ModeSwitch" Case of the name <b>DOES</b>
	 *            matter here.
	 * @param ep
	 *            Player
