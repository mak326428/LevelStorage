...
public class ItemCompactTeleporter extends Item implements IElectricItem {

	public static final String UNLOCALIZED_NAME = "compactTeleporter";
	public static final String NAME = "Compact Teleporter";
